...
public abstract class Enemy : MonoBehaviour, IDamageable, IComboable
{
    ...
    public void SetTimers()
    {
        ...
        EnemyTimers.times[(int)EnemyTimer.warningFlashTimer].OnTimeIsZero += DisableWarningSign;
        EnemyTimers.times[(int)EnemyTimer.warningFlashDelay].OnTimeIsZero += SecondWarningFlash;
    ...
    {
        EnemyTimers.SetTime((int)EnemyTimer.warningFlashTimer, FlashDuration);
    ...
    {
        EnemyTimers.SetTime((int)EnemyTimer.warningFlashDelay, FlashDuration);
    }
